...
local simpleParticleTimed = require(ReplicatedStorage.GameplayCore.Utility.simpleParticleTimed)

local dashParticlesTemplate = ReplicatedStorage.GameplayCore.Movement.Effects.DashParticles
