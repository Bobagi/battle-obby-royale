--[[
	...
	* Utility
	...
	The Controller class (found in `ReplicatedStorage.Platformer.Scripts.Controller`)
	...
	done inside `ReplicatedStorage.Platformer.Scripts.ControlScript`.

	## Actions

	Actions are the various platforming moves that a character can make, such as rolling
	or double jumping. These are all stored as modules in `ReplicatedStorage.Platformer.Scripts.Actions`.
